...
{
    if (blessed $data->[0] and ref($data->[0]) =~ /^AI::MXNet::NDArray(?:::Slice)?$/)
    {
...
has 'dataset'       => (is => 'rw', isa => 'AI::MXNet::Gluon::Data::Set|AI::MXNet::NDArray|AI::MXNet::NDArray::Slice|PDL', required => 1);
