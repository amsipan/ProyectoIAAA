...
#    float16 => ,
    ...
    bool    => PDL::Type->new('byte')->enum,
};

#use constant DTYPE_MX_TO_PDL => {#https://github.com/apache/incubator-mxnet/issues/20851
#    0 => 6,
#    1 => 7,
#    2 => 6,
#    3 => 0,
...
#    int64   => 5
#};
use constant DTYPE_PDL_TO_MX => {#Changed by Josafa
...

{
    ...
    *PDL::at = sub {
        ...
        return $orig_at->($self, @args) if $self->ndims == 1 || $self->ndims == 0; # Nuevo
